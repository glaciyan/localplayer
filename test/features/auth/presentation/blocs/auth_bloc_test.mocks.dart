...
// in localplayer/test/features/auth/presentation/blocs/auth_bloc_test.dart.
...
import 'package:localplayer/core/services/presence/presence_interface.dart'
    as _i6;
import 'package:localplayer/features/auth/data/IAuthRepository.dart' as _i3;
...
class MockIAuthRepository extends _i1.Mock implements _i3.IAuthRepository {
  ...
  @override
  _i4.Future<Map<String, dynamic>> signIn(String? name, String? password) =>
      (super.noSuchMethod(
            Invocation.method(#signIn, [name, password]),
  ...
  @override
  _i4.Future<dynamic> signUp(String? name, String? password) =>
      (super.noSuchMethod(
            Invocation.method(#signUp, [name, password]),
...
///
/// See the documentation for Mockito's code generation for more information.
class MockIGeolocatorService extends _i1.Mock
    implements _i5.IGeolocatorService {
  MockIGeolocatorService() {
    _i1.throwOnMissingStub(this);
  }
...
/// A class which mocks [IPresenceService].
///
/// See the documentation for Mockito's code generation for more information.
class MockIPresenceService extends _i1.Mock implements _i6.IPresenceService {
  MockIPresenceService() {
    _i1.throwOnMissingStub(this);
  }
  ...
  _i4.Future<void> updateLocation({
    ...
    required double? fakingRadiusMeters,
  }) =>
      (super.noSuchMethod(
            Invocation.method(#updateLocation, [], {
              #latitude: latitude,
              #longitude: longitude,
              #fakingRadiusMeters: fakingRadiusMeters,
            }),
